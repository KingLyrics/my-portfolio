<template>
  <div class="pt-28  md:pt-52 pb-56 max-w-md mx-auto">
    <h1 class="text-center font-Josefin text-4xl pb-10 font-[500]">My Tech Stack</h1>
    <div>
    ...
    <h1
      class="text-center my-44 px-4 md:px-0 lg:my-96 text-4xl font-Josefin lg:text-4xl hover:scale-150 transition-all ease-in-out ">
